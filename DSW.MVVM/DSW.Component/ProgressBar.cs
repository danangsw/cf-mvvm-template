...
namespace DSW.Component
{
    public class ProgressBar : Panel
    {
        ...
        private void ProgressBar_Resize(object sender, EventArgs e)
        {
            ...
            //
            ProgressBar.DisposeToNull(offscreenImage);
            ProgressBar.DisposeToNull(offscreen);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            ProgressBar.DrawImage(offscreen, backgroundCacheImage, ClientRectangle, ClientRectangle);
            ...
            ProgressBar.DrawImage(offscreen, overlayCacheImage, ClientRectangle, ClientRectangle);
