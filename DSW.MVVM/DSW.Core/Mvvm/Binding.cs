...
namespace DSW.Core.MVVM
{
    ...
    internal abstract class Binding<TView, TControl, TViewModel> : Binding<TView> where TViewModel : INotifyPropertyChanged
    {
        ...
        protected Binding(TView view, TControl control, TViewModel viewModel)
        {
            ...
            Control = control;
            ViewModel = viewModel;
            _Configuration = new BindingConfiguration();
        }
        ...
        /// </summary>
        /// 
        private BindingConfiguration _Configuration;
        protected override BindingConfiguration Configuration { get { return _Configuration;  } }
        ...
        {
            var valueToSet = ViewModelPropertyInfo.GetValue(ViewModel,null);
            ViewPropertyInfo.SetValue(Control, valueToSet,null);
        }
